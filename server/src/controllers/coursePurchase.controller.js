    ...
    line_items: [
      {
        price_data: {
          ...
          unit_amount: course.coursePrice * 100, //Amount should be in cent
        },
        quantity: 1,
      },
    ],
...
export const getCourseDetailWithPurchaseStatus = asyncHandler(
  async (req, res) => {
    ...
    return res
      .status(200)
      .json({
        course, purchased: purchased? "true": "false",
      })
  }
);

export const getAllPurchaseCourse = asyncHandler(async (_, res) => {
