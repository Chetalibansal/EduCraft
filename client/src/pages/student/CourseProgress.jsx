...
const CourseProgress = () => {
  ...
  // initialize first lecture if not exist
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 mt-20">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        {/* Lecture Sidebar */}
        <div className="flex flex-col w-full md:w-2/5 border-t md:border-t-0 md:border-l border-gray-200 md:pl-4 pt-2 md:pt-0">
          ...
          <div className="flex-1 overflow-y-auto ">
            {courseDetails?.lectures.map((lecture) => (
              ...
              >
                <CardContent className="flex lg:h-0.2 h-0 items-center justify-between lg:p-3 p-2">
